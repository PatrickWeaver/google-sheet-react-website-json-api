...
const Header = __webpack_require__(30);
const Content = __webpack_require__(31);
...
const Header = function() {
  return (
    React.createElement("h1", null, "Google Sheets App: React Website")
  ); 
}
...
const Worksheets = __webpack_require__(32);
const Items = __webpack_require__(33);
...
const Content = function(props) {
  return (
    React.createElement("div", {id: "content"}, 
      ...
      React.createElement(Worksheets, {worksheets: props.worksheets}), 
      React.createElement(Items, {items: props.rows})
    )
  ); 
}
...
const Worksheets = function(props) {
  ...
  const worksheetItems = props.worksheets.map((sheet) =>
    React.createElement("li", {key: sheet.title}, React.createElement("a", {href: ""}, sheet.title))                                            
  );
  
  return (
    React.createElement("div", {id: "Worksheets"}, 
...
const Item = __webpack_require__(34);
...
const Items = function(props) {
  ...
  const items = props.items.map((item) =>
    React.createElement("li", {key: item.Id}, React.createElement(Item, {currentItem: item}))                                            
  );
...
const Item = function(props) {
  ...
  const currentItem = Object.keys(props.currentItem).map(function(key) {
    if (key != "Image"){
      return React.createElement("li", {key: key}, key, ": ", props.currentItem[key]);
    } else {
      return null
    }
  });
